...
3. Copiar la URI:
   ```
   mongodb+srv://wikiadmin:***@wiki-collection.xxxxx.mongodb.net/wiki_collection?retryWrites=true&w=majority
   ```
...
|----------|-------|-------------|
| `SPRING_MONGODB_URI` | `mongodb+srv://wikiadmin:***@cluster0.xxxxx.mongodb.net/wiki_collection?retryWrites=true&w=majority` | URI de Atlas |
| `PORT` | La asigna Render automáticamente | El Dockerfile la mapea a server.port |
...
| Region | Igual que la región de Atlas (ej. Ireland) |
| Branch | `main` |
...
3. Configurar DNS en el registrar: `CNAME` o `A` según instrucciones de Render
...
```
SPRING_MONGODB_URI=mongodb+srv://wikiadmin:***@cluster0.xxxxx.mongodb.net/wiki_collection?retryWrites=true&w=majority
...
# 2. Restore a Atlas
mongorestore --uri="mongodb+srv://wikiadmin:***@cluster0.xxxxx.mongodb.net/wiki_collection" \
