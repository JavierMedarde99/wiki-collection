...
Las imágenes subidas **no** se guardan en MongoDB ni en el servidor: viven en Catbox
y en la base de datos solo se almacena su URL pública en el campo de imagen de cada
entidad (`frontpage`, `thumbnailUrl`, `posterUrl`, etc.).
