...
**Nota:** `GamePersistenceAdapter`, `BoardGamePersistenceAdapter`, `MagicCardPersistenceAdapter`, `MovieShowPersistenceAdapter` y `DeckPersistenceAdapter` siguen el mismo patrón pero con sus respectivos criterios.
...
public class MovieShowEntityMapper {
    ...
    public MovieShowEntity toEntity(MovieShow domain) { ... }
}
```
...
- **movie_shows** — Colección de películas/series
- **decks** — Colección de mazos Commander
